...
POLLUTION_BASELINES = {
    ...
    'Maharashtra': {'pm25': 55, 'pm10': 100, 'no2': 25, 'so2': 6},
    'Odisha': {'pm25': 50, 'pm10': 95, 'no2': 20, 'so2': 5},
    'Andhra Pradesh': {'pm25': 45, 'pm10': 85, 'no2': 18, 'so2': 4},
    'Karnataka': {'pm25': 40, 'pm10': 75, 'no2': 20, 'so2': 5},
    'Tamil Nadu': {'pm25': 35, 'pm10': 70, 'no2': 18, 'so2': 4},
    'Kerala': {'pm25': 25, 'pm10': 50, 'no2': 12, 'so2': 2},
}

# Water availability baselines (annual mm equivalent)
WATER_BASELINES = {
    'Delhi': {'rainfall': 800, 'groundwater': 0.4, 'surface_water': 1.5},
    'Maharashtra': {'rainfall': 1200, 'groundwater': 0.6, 'surface_water': 3.0},
    'Uttar Pradesh': {'rainfall': 900, 'groundwater': 0.5, 'surface_water': 2.5},
    'Bihar': {'rainfall': 1100, 'groundwater': 0.7, 'surface_water': 4.0},
    'West Bengal': {'rainfall': 1800, 'groundwater': 0.8, 'surface_water': 5.0},
    'Tamil Nadu': {'rainfall': 1000, 'groundwater': 0.5, 'surface_water': 2.0},
    'Karnataka': {'rainfall': 1100, 'groundwater': 0.5, 'surface_water': 2.5},
    'Gujarat': {'rainfall': 600, 'groundwater': 0.3, 'surface_water': 1.0},
    'Rajasthan': {'rainfall': 400, 'groundwater': 0.2, 'surface_water': 0.5},
    'Madhya Pradesh': {'rainfall': 1000, 'groundwater': 0.5, 'surface_water': 2.0},
    'Andhra Pradesh': {'rainfall': 900, 'groundwater': 0.4, 'surface_water': 2.0},
    'Kerala': {'rainfall': 3000, 'groundwater': 0.9, 'surface_water': 6.0},
    'Punjab': {'rainfall': 600, 'groundwater': 0.3, 'surface_water': 3.5},
    'Haryana': {'rainfall': 500, 'groundwater': 0.3, 'surface_water': 2.0},
    'Jharkhand': {'rainfall': 1300, 'groundwater': 0.6, 'surface_water': 3.0},
    'Chhattisgarh': {'rainfall': 1200, 'groundwater': 0.6, 'surface_water': 2.5},
    'Odisha': {'rainfall': 1500, 'groundwater': 0.7, 'surface_water': 4.0},
    'Assam': {'rainfall': 2500, 'groundwater': 0.9, 'surface_water': 7.0},
    'Uttarakhand': {'rainfall': 1500, 'groundwater': 0.7, 'surface_water': 5.0},
    'Himachal Pradesh': {'rainfall': 1200, 'groundwater': 0.6, 'surface_water': 4.0},
}
...
def generate_weekly_environmental_data(state, year, week):
    ...
    yield_index = crop_growth * (0.7 + random.random() * 0.3)
